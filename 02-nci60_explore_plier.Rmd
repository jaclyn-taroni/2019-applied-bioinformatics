...
[`remotes`](https://github.com/r-lib/remotes#readme)) is the [`install_version`](https://rdrr.io/cran/remotes/man/install_version.html)
function that allows us to install a specific package version from CRAN which
...
```{r}
# should have dplyr from last notebook or earlier in the course, but in the 
